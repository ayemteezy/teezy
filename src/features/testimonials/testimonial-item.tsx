...
export const TestimonialItem = ({ data }: TestimonialItemProps) => {
	return (
		<Card className="relative flex h-fit cursor-pointer flex-col gap-0 rounded-xl px-4 shadow-lg/5 transition-all duration-300 ease-out hover:scale-105 hover:shadow-xl/7">
			<div className="flex min-h-0 flex-1 flex-col">
				...
				<div className="flex min-h-0 flex-1 items-center justify-center overflow-hidden py-4">
					<p className="font-normal font-sans leading-normal">"{data.quote}"</p>
				</div>
			</div>
