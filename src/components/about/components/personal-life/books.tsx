...
export const Books = () => {
  return (
    <Card className="h-auto relative bg-gradient-to-br from-primary/5 to-primary/20 backdrop-blur-sm border-primary/20 overflow-hidden dark:from-primary/10 dark:to-primary/30 dark:border-primary/30">
